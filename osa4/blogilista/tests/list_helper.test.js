...
describe('total likes', () => {
  ...
  test('one blog with random likes returns its likes', () => {
    const blogs = [{
  ...
  test('multiple blogs should return correct amount of likes', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
...
describe('favorite blog', () => {
  ...
  test('multiple blogs should return correct blog', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
...
describe('most blogs', () => {
  ...
  test('multiple blogs should work', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
  ...
  test('single blog returns its author', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
